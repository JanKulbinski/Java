This program creates GUI which shows how bubble sort's process runs with random numbers. Thanks to used semaphore, thread which is responsible for sorting can be stopped
