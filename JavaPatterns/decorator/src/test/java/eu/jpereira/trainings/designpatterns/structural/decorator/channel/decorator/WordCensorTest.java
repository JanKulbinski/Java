...
public class WordCensorTest extends AbstractSocialChanneldDecoratorTest {
	...
	public void testAppendURL() {
		...
		SocialChannel channel = builder.with(new WordCensor("is")).getDecoratedChannel(props);

		// Now call channel.deliverMessage
		channel.deliverMessage("this is a message is");
		// Spy channel. Should get the one created before
		TestSpySocialChannel spyChannel = (TestSpySocialChannel) builder.buildChannel(props);
		assertEquals("this ### a message ###", spyChannel.lastMessagePublished());
	}
