...
public class ReportAssembler {
	...
	public Report getReport(String type) {
		...
		if (type.equals("JSON")) {
			JSONReportBody reportBody = new JSONReportBody(saleEntry);
			report.setReportBody(reportBody);
		} else if (type.equals("XML")) {
			XMLReportBody reportBody = new XMLReportBody(saleEntry);
			report.setReportBody(reportBody);
		} else if (type.equals("HTML")) {			
			HTMLReportBody reportBody = new HTMLReportBody(saleEntry);
			report.setReportBody(reportBody);
		}
